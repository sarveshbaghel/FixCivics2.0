    ...
    Scaffold(
        ...
        Column(
            ...
            PolicySection(
                ...
                content = "When you use Trace, we collect the following information:\n\n" +
            ...
            PolicySection(
                ...
                content = "Your information is used to:\n\n" +
                        ...
                        "• Improve the Trace platform and user experience"
            )

            PolicySection(
                title = "3. Authentication & Security",
                content = "Trace offers multiple secure sign-in methods:\n\n" +
            ...
            PolicySection(
                ...
                content = "Trace uses your device location only when you actively submit a report. " +
